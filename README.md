...
## Install
    ...
    $ git clone https://github.com/prrdee/cgi-birdwatch-frontend.git
    $ cd PROJECT
    $ npm install

### Configure app

Change base url in `/src/services/observations.js` to `api/observations` to build and deploy with the backend app
